...
class ExecutionRow(Base):
    ...
    agent_executions: Mapped[list[AgentExecutionRow]] = relationship(
        back_populates="execution"
    )
    script_versions: Mapped[list[ScriptVersionRow]] = relationship(
        back_populates="execution"
    )
...
class EvaluationRow(Base):
    ...
    script_version: Mapped[ScriptVersionRow] = relationship(
